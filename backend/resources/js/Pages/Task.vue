    ...
    */
    ...
    function isInteractionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var subjectInstanceId in subjectInstances) {
            ...
            // constraint
            if (
                !allConstraintsPass(subjectConfig.constraints, subjectRange, otherEventStore, state.businessHours, context)
            ) {
                return false;
            }
            // overlap
    ...
    function isDateSelectionPropsValid(state, context, dateSpanMeta, filterConfig) {
        ...
        for (var relevantInstanceId in relevantInstances) {
            ...
            if (rangesIntersect(selectionRange, relevantInstance.range)) {
                ...
                if (
                    selectOverlapFunc &&
                    !selectOverlapFunc(new EventApi(context, relevantDefs[relevantInstance.defId], relevantInstance), null)
                ) {
                    return false;
                }
            }
            ...
            return createElement(
                ...
                toolbarConfig.headerToolbar &&
                    createElement(
                        Toolbar,
                        __assign(
                            { ref: this.headerRef, extraClassName: 'fc-header-toolbar', model: toolbarConfig.headerToolbar },
                            toolbarProps,
                        ),
                    ),
                createElement(
        ...
        TableRow.prototype.renderFgSegs = function(
            ...
            if (framePositions) {
                for (var _i = 0, segs_1 = segs; _i < segs_1.length; _i++) {
                    ...
                    // TODO: simpler way? NOT DRY
                    var isAbsolute =
                        segIsHidden[instanceId] || isMirror || seg.firstCol !== seg.lastCol || !seg.isStart || !seg.isEnd;
    ...
    */
    ...
    var ListViewHeaderRow = /** @class */ (function(_super) {
        ...
        ListViewHeaderRow.prototype.render = function() {
            ...
            var hookProps = __assign(
                { date: dateEnv.toDate(dayDate), view: viewApi, text: text, sideText: sideText, navLinkData: navLinkData },
                dayMeta,
            );
                ...
                function(rootElRef, customClassNames, innerElRef, innerContent) {
                    return createElement(
                        ...
                        createElement(
                            ...
                            createElement(
                                'div',
                                { className: 'fc-list-day-cushion ' + theme.getClass('tableCellShaded'), ref: innerElRef },
                                innerContent,
                            ),
                        ),
                    );
